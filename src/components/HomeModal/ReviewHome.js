...
const ReviewHome = () => {
    ...
    const { setHomeModal, setContactModal } = useContext(ModalContext)
        ...
        <section>
            <div className='relative'>
                ...
                <div className='space-y-5'>
                    ...
                    <div className='w-[683px] h-[70px]  bg-[#FFFFFF] flex justify-center shadow-2xl p-3 shadow-[#00000029] absolute'>
