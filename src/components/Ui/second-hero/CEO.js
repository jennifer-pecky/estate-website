        ...
        <section className={`pt-10 px-20 bg-[#F9F9F9] ${globalPadding}`}>
            <div className='flex w-full max-w-full space-x-10 '>
                <div className='w-full max-w-[30%] relative'>
                    ...
                    <div className={`bg-[#666666] h-[400px]  rounded-lg mb-10 absolute w-full -top-20 `}></div>
                </div>

                <div className=' w-[70%] flex flex-col space-y-6'>
                    <h1 className='text-[2rem] leading-[2.6rem] text-[#000000] font-semibold'>We've been working in real estate <br /> markets since in the 90s</h1>
                    ...
                    <h2 className='text-[1.6rem] leading-[2.6rem] text-[#000000] font-semibold'>Major Jr. - CEO</h2>
                </div>
            </div>
        </section>
    )
