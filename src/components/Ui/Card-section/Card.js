...
const Card = ({ imgUrl, title, desc, prize, openSpots, rating, reviews, rentSpots }) => {
    ...
    return (
        <section className='max-w-[100%] relative'>
            ...
            {/* <div className='flex flex-col mt-5 mb-9 w-full h-[650px] border-2 border-[#707070] rounded-[8px] space-y-2'>
                ...
                <div className='px-7'>
                    <p className='font-bold text-base tracking-wide whitespace-nowrap'>{title}</p>
                    <p className='text-[#EC522E] font-extrabold tracking-wide'>{prize}</p>
                    <p className='font-medium tracking-wide whitespace-nowrap'>{desc}</p>
                    ...
                    <div className='flex space-x-3 '>
                        <button className='text-sm  font-semibold mt-2 rounded-[6px] w-[95px] h-[42px] hover:bg-[#707070] text-[#EC522E] border-2 border-[#EC522E] relative' onClick={setHomeModal} >VIEW</button>
